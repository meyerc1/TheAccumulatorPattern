...
def run_test_sum_more_cosines():
    ...
    # Test 3:
    expected3 = -0.41614  # This is APPROXIMATELY the correct answer.
    answer3 = sum_more_cosines(2, 2)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 5:
    expected5 = 4
    answer5 = count_sines_vs_cosines(3)
